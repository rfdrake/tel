...
# color interface
$t = App::Tel::Color::Cisco->new->parse('0 output errors, 0 collisions, 1 interface resets');
...
$t = App::Tel::Color::Cisco->new->parse($scm);
...
# sh proc cpu
$t = App::Tel::Color::Cisco->new->parse('   6    80639888   5519824 14609 0.00%  0.34%  1.25%   0 Check heaps');
$o = "   6    80639888   5519824 14609 \e[32m0.00\e[0m%  \e[33m0.34\e[0m%  \e[31m1.25\e[0m%   0 Check heaps";
is($t, $o, 'sh proc cpu');


$t = App::Tel::Color::Cisco->new->parse('Vlan55 is up, line protocol is down');
...
# modification
$t = App::Tel::Color::Cisco->new->parse('0 packets input, 0 bytes, 0 no buffer');
